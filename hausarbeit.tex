...
\author{\LARGE Markus Bullman \& Julius Hackel}
\title{\huge Hausarbeit \\[0.4cm] \Huge \textbf{Vektoruhren} \\[0.5cm] \huge Ausgewählte Probleme der verteilten Systeme }
\maketitle
...
\cleardoublepage
\input{Kapitel/5_Besonderheiten.tex}
\cleardoublepage
